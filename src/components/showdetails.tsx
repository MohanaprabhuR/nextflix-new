              ...
              {groupedVideos[selectedSeason]?.map((video: Video) => (
                ...
                >
                  <div className="relative flex items-center justify-center">
                    ...
                    />
                    <div className="absolute opacity-0 group-hover:opacity-100 duration-100 delay-100 transition-all ease-in-out   w-12 flex items-center justify-center h-12 bg-[rgba(255,255,255,0.31)] shadow-[0px_5px_21px_0px_rgba(0,0,0,0.25)] backdrop-blur-[5px] rounded-[77px]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="11"
                        height="14"
